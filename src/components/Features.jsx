      ...
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          ...
          <p className="max-w-md font-circularWeb text-lg text-blue-50 opacity-50 mt-5">
            ...
            recommendations, community-driven leaderboards, and immersive game
            reviews—all designed to level up your gaming journey.
          </p>
        </div>
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
            <BentoCard
              ...
              description="Gaming meets NFTs and anime! Unlock exclusive collectibles, enjoy captivating gameplay, and explore a world of innovation."
            />
          </BentoTilt>
          <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
            <BentoCard
              ...
              description="Experience seamless gameplay, lightning-fast loading, and a community-driven platform designed to elevate your gaming journey."
            />
          </BentoTilt>
          ...
          <BentoTilt className="bento-tilt_2">
            <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
              <h1 className="bento-title special-font max-w-64 text-black">
                {" "}
                <b>m</b>ore Co<b>m</b>ing S<b>oo</b>n...!!!
              </h1>
